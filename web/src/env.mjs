...
export const env = createEnv({
  ...
  server: {
    ...
    AUTH_CUSTOM_ID_TOKEN_SIGNED_RESPONSE_ALG: z.enum(["HS256", "RS256", "PS256", "ES256"]).optional(),
  ...
  runtimeEnv: {
    ...
    AUTH_CUSTOM_ID_TOKEN_SIGNED_RESPONSE_ALG: process.env.AUTH_CUSTOM_ID_TOKEN_SIGNED_RESPONSE_ALG,
